...
namespace ns3 {
    ...
    void UdpServerHelper::SetAttribute(std::string name, const AttributeValue &value) {
    ...
    Ptr<UdpServer> UdpServerHelper::GetServer(void) {
        return m_server;
    }
    ...
    void UdpClientHelper::SetAttribute(std::string name, const AttributeValue &value) {
        m_factory.Set(name, value);
    }
